    ...
    for (let i = 0; i < prodotti.length; i++) {
        ...
        <div class="card shadow" >
                        ...
                        <div class="card-body">
                          ...
                          <p><a href="http://127.0.0.1:5500/pagina3.html?id=${prodotti[i]._id}" class="btn btn-warning">Modifica</a></p>
                          <p><a href="http://127.0.0.1:5500/pagina2.html?id=${prodotti[i]._id}" class="btn btn-secondary">Scopri di più</a></p>
                        </div>
                      </div>`
